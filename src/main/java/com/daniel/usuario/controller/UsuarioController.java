package com.daniel.usuario.controller;

import com.daniel.usuario.business.UsuarioService;
...
public class UsuarioController {
    ...
    // Assim funciona também... Muda o Endpoint, fica /usuario/email_do_usuario
//    @GetMapping("/{email}")
